...
function updateFederatedExtension(inputDir, jsonFilePath) {
  ...
  const target = extensions.find(ext => ext.name === 'jupyter-monstra');

  if (!target) {
    console.error('Extension with name "jupyter-monstra" not found.');
    process.exit(1);
  }
...
const inputPath = 'monstra/labextension';
const outputPath = 'demo/_output/extensions/jupyter-monstra';
